...
//bike
var bikeimg,bike,bike3right,bike3left;
...
//bike.changeAnimation("bikeimg",bikeimg);
...
if (CarsGroup.isTouching(bike)|| bike.x<0 || bike.x>800){
  crash();
...
function crash(){
crash = createSprite(350,700,500,20);
crash.shapeColor = "red";
crashsnd.play();
gameState=END;
